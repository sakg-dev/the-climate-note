...
const Hero = () => {
    return (
        <div className='h-screen flex flex-col justify-center text-center items-center gap-8'>
            ...
            <h1 className='text-[#2d5016] text-6xl font-bold'>The Climate Note</h1>
            <div className='text-[#5a7a4a] flex flex-col gap-1 text-xl'>
